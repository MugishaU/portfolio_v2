...
export const projects: Project[] = [
  {
    ...
    description:
      'A WordPress website for Lewisham Youth Theatre, a charity offering free, inclusive theatre opportunities for young people aged 8-25. Visitors can explore programmes, discover upcoming events, and find ways to get involved.',
